class Card {
  ...
  // _setEventListeners() {
  // console.log("_cardLikeButton:", this._cardLikeButton);
  // console.log("_cardDeleteButton:", this._cardDeleteButton);
  // console.log("_cardElement:", this._cardElement);
  // console.log("_cardElement:", this._cardElement);
  // console.log(
  //   "_cardElement.querySelector('.card__delete-button'):",
